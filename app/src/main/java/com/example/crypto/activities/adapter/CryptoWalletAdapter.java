package com.example.crypto.activities.adapter;
...
import com.example.crypto.activities.domain.CryptoWallet;
...
public class CryptoWalletAdapter extends RecyclerView.Adapter<CryptoWalletAdapter.Viewholder> {
    ...
    public class Viewholder extends RecyclerView.ViewHolder{
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            changePercentTxt=itemView.findViewById(R.id.cangePercentTxt);
